...
class InpaintGenerator(BaseNetwork):
    ...
    def forward(self, x):
        ...
        up_1 = self.branch_up.encoder0(x)
        up_2 = self.branch_up.encoder1(up_1)
        up_3 = self.branch_up.encoder2(up_2)

        up_4 = self.branch_up.middle(up_3)

        up_5 = self.branch_up.decoder_0(up_4)
        up_6 = self.branch_up.decoder_1(up_5)
        up_7 = self.branch_up.decoder_2(up_6)

        # -------------------------------------------------------------
        down_1 = self.branch_down.encoder0(x)
